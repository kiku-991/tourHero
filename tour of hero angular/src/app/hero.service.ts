...
export class HeroService {
  ...
  addHero(hero: Hero): Observable<Hero> {
    const addHeroUrl = '/addHero';
    return this.http.post<Hero>(this.heroesUrl+addHeroUrl, hero, this.httpOptions).pipe(
     tap(_=> this.log(`added hero successful`)),
...
deleteHero(id: number): Observable<Hero> {
  ...
  const deleteUrl = this.heroesUrl+`/delete/${id}`;
